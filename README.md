# 🎱 Calling It Corner - Pool League Audio Player

An interactive audio player with pool hall aesthetics for CDA Pool Leagues tracks.
...
- **Bars** - Frequency bars with pool hall colors (green, gold, brown)
- **Circle** - Radial frequency visualization
- **Waveform** - Oscilloscope-style waveform
- **Ripples** - Concentric ripples like pool table patterns
...
- Canvas-based visualization with pool-themed gradients
- No external dependencies - pure HTML, CSS, and JavaScript
- High-quality audio processing (48kHz sample rate, 2048 FFT size)
